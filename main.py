...
for categories_name, categories_href in all_categories.items():
    ...
    with open(f'data/{count}_{categories_name}.csv', 'w', encoding='utf-8', newline='') as file:
    ...
    with open(f'data/{count}_{categories_name}.csv', 'a', encoding='utf-8', newline='') as file:
        writer = csv.writer(file)
